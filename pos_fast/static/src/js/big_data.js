odoo.define('pos_fast.big_data', function (require) {
    ...
    models.PosModel = models.PosModel.extend({
        ...
        sync_with_backend: function (model, datas, dont_check_write_time) {
            ...
            if (model == 'res.partner') {
                ...
                if (partner_datas.length) {
                    ...
                    self.update_customer_in_cart(partner_datas);
                }
            }
            if (model == 'product.product') {
                ...
                if (product_datas.length) {
                    ...
                    self.update_products_in_cart(product_datas);
                }
            }
        ...
        get_modifiers_backend_all_models: function () {
            ...
            var model_values = this._get_model_big_datas();
